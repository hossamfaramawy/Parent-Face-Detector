...
#train the model 
#best model based on the vlidation and testing--------------------------
model_checkpoint_callback = keras.callbacks.ModelCheckpoint(
    filepath='./models/autosaved_models/autosavedmodel5000decLr.h5',
...
history = autoencoder.fit(x_train, y_train, epochs=epochs, batch_size=batch_size, verbose=2,
              validation_data=(x_test,y_test),
              callbacks=[model_checkpoint_callback], shuffle = True)

#history=autoencoder.fit(x_train,y_train,batch_size=batch_size,epochs=epochs,verbose=1,validation_data=(x_test, y_test),shuffle = True)


#--------------------------save the model and weights--------------------------
#autoencoder.save('./models/autoencoder_model200v2.h5')
#autoencoder.save_weights('./models/autoencoder_weights200v2.h5')
 """
...
autoencoder_loaded = load_model('./models/autosavedmodel7500.h5')
...
f.save("autosavedmodel5000(lr=0.0001)newDataset.png")
#f.show()
